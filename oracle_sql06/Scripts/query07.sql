...
DELETE FROM ACCOUNTS WHERE ID IN (13, 14);
...
INSERT INTO TEST1 VALUES(11, 'H');


CREATE OR REPLACE FUNCTION FUNC_SAMPLE(
 NUM1  EMPLOYEES.EMPLOYEE_ID%TYPE
 ) RETURN NUMBER
IS
BEGIN
 DBMS_OUTPUT.PUT_LINE('PL/SQL 구문...');
 RETURN VALUE;
END;
